...
| [assets/demo-discord.png](./assets/demo-discord.png) | Discord 揪團實拍（2026-09-19，已結算的彙總與點餐面板） |
| [assets/demo-web.png](./assets/demo-web.png) | 校內網站儀表板實拍（2026-09-18） |
| [assets/mocks/](./assets/mocks/) | 先前產生 Discord PNG 的靜態 HTML（非正式執行頁；現行示範圖改拍論壇貼文） |

網站示意改拍正在跑的 `web` 容器即可。Discord 示範圖改拍論壇貼文裡的彙總訊息。
